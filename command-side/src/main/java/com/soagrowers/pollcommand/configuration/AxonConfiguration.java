package com.soagrowers.pollcommand.configuration;

import com.mongodb.Mongo;
import com.soagrowers.pollcommand.aggregates.PollAggregate;
...
/*    @Bean
    ...
    @Bean
    EventSourcingRepository<PollAggregate> PollEventSourcingRepository() {
        EventSourcingRepository<PollAggregate> repo = new EventSourcingRepository<PollAggregate>(PollAggregate.class, eventStore());
     ...
     */
    @Bean
    AggregateAnnotationCommandHandler<PollAggregate> pollAggregateCommandHandler() {
        AggregateAnnotationCommandHandler<PollAggregate> handler = new AggregateAnnotationCommandHandler<PollAggregate>(
                PollAggregate.class,
                PollEventSourcingRepository(),
                commandBus());
        return handler;
    }
