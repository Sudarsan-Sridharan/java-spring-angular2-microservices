 ...
 */
public class PollRestControllerParamValidityTest {

    PollRestController controller;
    ...
    public void setup() {
        ...
        controller = new PollRestController();
    ...
    public void testAddWithGoodRequestParams() {
        ...
        //Act
        controller.add(UUID.randomUUID().toString(), "Test Add Poll", mockHttpServletResponse);
